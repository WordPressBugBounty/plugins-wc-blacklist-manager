...
if (!class_exists('YoOhw_Settings_Content')) {
    ...
    class YoOhw_Settings_Content {
        ...
        public function section_callback() {
            echo '<p>' . esc_html__('If you disable the menu then the Licenses tab will be moved to Wordpress Settings.', 'wc-blacklist-manager-premium') . '</p>';
        }
        ...
        public function disable_menu_field_callback() {
            ...
            <span><?php esc_html_e('Hide the YoOhw Studio information (White label)', 'wc-blacklist-manager-premium'); ?></span>
            <p class="description"><?php esc_html_e('Enabling this option will hide everything about us. Ex: Menu, documents, support buttons, etc.', 'wc-blacklist-manager-premium'); ?></p>
            <?php
        }
